...
import cz.janburda03.numintegrator.parsing.exceptions.MissingRightParenthesisException;
import cz.janburda03.numintegrator.parsing.exceptions.UnexpectedBinaryOperatorException;
import cz.janburda03.numintegrator.parsing.exceptions.UnexpectedTokenException;
import cz.janburda03.numintegrator.parsing.tokenizing.*;
        ...
        return switch (token) {
            ...
            case OperationToken opToken -> {
                if (opToken.getOperation().getArity() == 1) {
                    Expression sub = parsePrimary(); // parsing the operation following the unary operation
